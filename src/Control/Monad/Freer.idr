...
-- This is a partial port of https://github.com/robrix/freer-cofreer
...
-- TODO can it be made total?
partial
runFreer : ({x : Type} -> f x -> Freer f x) -> Freer f result -> result
runFreer refine = iterFreer (\xz, fx => xz $ runFreer refine $ refine fx)
...
-- 
-- TODO unfold lazily, making this suitable for stepwise evaluation of
-- nonterminating programs (and total).
partial
